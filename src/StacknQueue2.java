...
larger fish eats the smaller one. More precisely, we say that two fish P and Q 
meet each other when P < Q, B[P] = 1 and B[Q] = 0, and there are no living fish 
...
public int aliveFishes(int[] A, int[] B); }
...
public class StacknQueue2 {
    ...
    public static void main(String[] args) {
        int[] A = {4,3,2,1,5};
        int[] B = {0,1,0,0,0};
        System.out.println(aliveFishes(A,B));
    }

    public static int aliveFishes(int[] A, int[] B) {
