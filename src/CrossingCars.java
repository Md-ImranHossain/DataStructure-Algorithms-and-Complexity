...
where 0 ≤ P < Q < N, is passing when P is traveling to the east and Q is traveling 
to the west.
...
that, given a non-empty zero-indexed array A of N integers, returns the number of 
